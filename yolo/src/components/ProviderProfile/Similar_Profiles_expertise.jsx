...
export default class Similar_Profiles_expertise extends React.Component {
    ...
    render() {
            ...
            return(
                <div>
                    ...
                    {
                        (this.state.cityData && this.state.cityData.length ) ? this.state.cityData.map((itemz,idx)=>{
                            return (
                                <div>
                    ...
                    <div class="cardd" style={{textAlign: 'center'}}>
                        ...
                        <Link variant="caption">See all profiles from<br/>Expertise</Link>    
                    </div> 
