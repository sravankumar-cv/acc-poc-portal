...
export default function ProcHeader () {
    ...
    return(
        ...
        >
          ...
          <List>
                <ListItem button>
                    <ListItemIcon onClick={() => setName('Create New Job')}> <Icon className="fa fa-plus" /></ListItemIcon>
                    <ListItemText primary={'Create New Job'} />
                </ListItem>
              <ListItem button>
                <ListItemIcon onClick={() => setName('Pending Job')}> <Icon className="fa fa-hourglass" /></ListItemIcon>
                <ListItemText primary={'Pending Job'} />
              </ListItem>
              <ListItem button>
                <ListItemIcon onClick={() => setName('Completed Job')}> <Icon className="fa fa-check-circle-o" /></ListItemIcon>
                <ListItemText primary={'Completed Job'} />
              </ListItem>
              <ListItem button>
