...
var chip_style={fontSize: '10px', marginTop: '5px'}
            ...
            return(
                ...
                <div class="profile_container">
                    ...
                    <div style={{width: '96%', marginLeft: '2%', textAlign: 'left'}}>
                        ...
                        <Typography color="text" variant="body" style={{fontSize: '18px'}}>
                            Business & Individual Services Info
                            <DescriptionOutlinedIcon style={{float: 'right',fontSize: '17px', color: '#006699'}}/>
                        </Typography>
                        <br/><br/>
                ...
                <div class="similar_profiles_heading box_shadow">
                        <Typography variant="caption" style={{fontSize: '20px', color: '#4d4d4d'}}>Similar profiles in your network area, you may like...</Typography>
                        <br/>
                ...
                <div class="similar_container box_shadow" id="similar_profile_location">
                ...
                <div class="similar_container box_shadow" id="similar_profile_expertise">
                ...
                <div class="similar_container box_shadow" id="similar_profile_service">
